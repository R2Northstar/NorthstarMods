...
void function InitInGameMPMenu()
{
	...
	var switchteamButton = AddComboButton( comboStruct, headerIndex, buttonIndex++, "#SWITCH_TEAMS" )
	Hud_AddEventHandler( switchteamButton, UIE_CLICK, OnSwitchTeamButton_Activate )	
...
void function OnSwitchTeamButton_Activate( var button )
{
	DialogData dialogData

	dialogData.header = "#SWITCH_TEAMS"
	dialogData.message= "#switch_team_tip"
	dialogData.image = $"ui/menu/common/dialog_announcement_1"

	AddDialogButton( dialogData, "#YES", OnActualSwitchTeamButton_Confirm )
...
void function OnActualSwitchTeamButton_Confirm()
{
	CloseAllInGameMenus()
	ClientCommand("SwitchTheTeam")
}
