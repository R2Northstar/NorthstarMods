...
void function InitInGameMPMenu()
{
	...
	headerIndex++
	buttonIndex = 0
	var dummyHeader2 = AddComboButtonHeader( comboStruct, headerIndex, "" )
	var dummyButton2 = AddComboButton( comboStruct, headerIndex, buttonIndex++, "" )
	...
	var joinInviteButton = AddComboButton( comboStruct, headerIndex, buttonIndex++, "#NS_INVITE_JOIN_BUTTON" )
