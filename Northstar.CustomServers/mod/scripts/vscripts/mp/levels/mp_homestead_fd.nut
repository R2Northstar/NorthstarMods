...
{
    shopPosition = < -792.552, -4243.41, -7.65455>
    int index = 1
    print("INIT FRONTIERDATA")
    ...
    wave4.append(CreateWaitForTimeEvent(4.4000244,index++))
    ...
    wave4.append(CreateWaitForTimeEvent(4.1800537,index++))
    ...
    wave4.append(CreateWaitForTimeEvent(3.9300537,index++))
    ...
    wave4.append(CreateWaitForTimeEvent(3.9199219,index++))
    ...
    wave4.append(CreateWaitForTimeEvent(3.119995,index++))
    wave4.append(CreateToneSniperTitanEvent(< 1484.189941 , 968.218994 , 97.968803 >,< -0.922852 , -141.942993 , -1.582030 >,index++))
    wave4.append(CreateWaitForTimeEvent(5.0,index++))
    wave4.append(CreateWaitUntilAliveEvent(0,index++))
    wave4.append(CreateDroppodGruntEvent(< -1197.939941 , 1928.560059 , 80.031303 >,"",index++))
