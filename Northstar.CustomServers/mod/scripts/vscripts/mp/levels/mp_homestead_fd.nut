...
void function initFrontierDefenseData()
{
    ...
    shopAngles = < 9, 60, 0 >
	FD_spawnPosition = < 1274, -3722, -128 >
	...
	wave1.append(CreateWarningEvent( FD_IncomingWarnings.LightWave, index++ ))
    ...
    wave4.append(CreateRoninTitanEvent(< -1799.439941 , 1310.839966 , -164.218994 >,< -0.922852 , -151.830994 , -1.582030 >,"",index++,1,"",FD_TitanType.TITAN_ELITE))
    wave4.append(CreateWaitForTimeEvent(5.0,index++))
    wave4.append(CreateWaitUntilAliveWeightedEvent(12,index++))
    wave4.append(CreateSuperSpectreEvent(< -2191.379883 , 875.562988 , -139.968994 >,< -0.000000 , -142.382996 , 0.000000 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(0.11999512,index++))
    wave4.append(CreateRoninTitanEvent(< 3573.840088 , -2788.250000 , -68.250000 >,< 0.000000 , 0.000000 , 0.000000 >,"",index++,1,"",FD_TitanType.TITAN_ELITE))
    ...
    wave4.append(CreateIonTitanEvent(< 5136.720215 , -2059.379883 , -105.125000 >,< 0.000000 , 0.000000 , 0.000000 >,"",index++,1,"",FD_TitanType.TITAN_ELITE))
    ...
    wave4.append(CreateToneTitanEvent(< -515.187988 , 1099.160034 , -162.281006 >,< 0.000000 , -90.000000 , 0.000000 >,"",index++,1,"",FD_TitanType.TITAN_ELITE))
    ...
    wave5.append(CreateWaitForTimeEvent(5.0,index++))
    wave5.append(CreateWaitUntilAliveWeightedEvent(12,index++))
    wave5.append(CreateScorchTitanEvent(< 5251.529785 , 2049.280029 , 13.125000 >,< 0.000000 , -90.000000 , 0.000000 >,"",index++,1,"",FD_TitanType.TITAN_ELITE))
    wave5.append(CreateWaitForTimeEvent(0.8300781,index++))
    wave5.append(CreateScorchTitanEvent(< 4249.879883 , 2937.159912 , -44.156300 >,< 0.000000 , -90.000000 , 0.000000 >,"",index++,1,"",FD_TitanType.TITAN_ELITE))
