...
void function initFrontierDefenseData()
{
	...
	*/
	...
	WaveSpawn_TitanSpawn( wave3, "Ion", < 3554, 926, 171 >, 180, "", 1.0 )
	WaveSpawn_TitanSpawn( wave3, "Ion", < 1581, -2287, 136 >, 90, "", 1.0 )
	WaveSpawn_TitanSpawn( wave3, "Legion", < -2114,- 673, 17 >, 90, "", 2.5 )
	...
	WaveSpawn_TitanSpawn( wave3, "Sniper", < -1253, -291, 128 >, 90, "", 2.5 )
	WaveSpawn_TitanSpawn( wave3, "Monarch", < 2766, 1723, 120 >, 180, "", 2.5 )
	WaveSpawn_TitanSpawn( wave3, "Scorch", < 2035, 3927, 129 >, 180, "" )
	WaveSpawn_WaitEnemyAliveAmount( wave3, 0 )
	...
	WaveSpawn_TitanSpawn( wave3, "ArcTitan", < -2562, -1210, 105 >, 90, "" )
	WaveSpawn_WaitEnemyAliveAmount( wave3, 0 )
	
	WaveSpawn_Announce( wave3, "EliteTitans", 0.0 )
	WaveSpawn_TitanSpawn( wave3, "Scorch", < -2892, -1269, 107 >, 90, "", 0.6, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave3, "Ion", < -2621, -1261, 107 >, 90, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave3, "Ion", < -3184, -1291, 115 >, 90, "", 1.0, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_WaitEnemyAliveAmount( wave3, 0 )
