...
void function initFrontierDefenseData()
{
	...
	AddStationaryAIPosition( < 1906, 736, 146 >, eStationaryAIPositionTypes.LAUNCHER_REAPER )
	AddStationaryAIPosition( < 3152, 3594, 109 >, eStationaryAIPositionTypes.LAUNCHER_REAPER )
	AddStationaryAIPosition( < 1161, 3577, 94 >, eStationaryAIPositionTypes.LAUNCHER_REAPER )
	AddStationaryAIPosition( < -1156, 1756, 271 >, eStationaryAIPositionTypes.LAUNCHER_REAPER )
	AddStationaryAIPosition( < 2149, -871, 256 >, eStationaryAIPositionTypes.LAUNCHER_REAPER )
	AddStationaryAIPosition( < 3378, 2273, 108 >, eStationaryAIPositionTypes.LAUNCHER_REAPER )
	...
	*/
	...
	WaveSpawn_InfantrySpawn( wave1, "Stalker", < -1007, 410, 246 >, 0.0, "" )
	...
	WaveSpawn_ReaperSpawn( wave1, "Reaper", < 831, 1624, 142 >, 180, "" )
	...
	*/
	...
	WaveSpawn_ReaperSpawn( wave2, "Reaper", < 1453, 3347, 22 >, -90, "", 0.4 )
	WaveSpawn_ReaperSpawn( wave2, "Reaper", < 1818, 3232, 13 >, -90, "", 0.8 )
	WaveSpawn_ReaperSpawn( wave2, "TickReaper", < 3458, 3032, 93 >, -90, "", 0.8 )
	...
	WaveSpawn_ReaperSpawn( wave2, "Reaper", < 3380, 2657, 88 >, 180, "", 0.8 )
	WaveSpawn_ReaperSpawn( wave2, "Reaper", < 2418, 3569, 14 >, -90, "", 0.4 )
	WaveSpawn_ReaperSpawn( wave2, "TickReaper", < 1921, 3511, 12 >, -90, "", 1.2 )
	...
	*/
	...
	WaveSpawn_TitanSpawn( wave3, "Scorch", < 314, 2055, 168 >, -90, "leftDangerClose", 1.4 )
	...
	WaveSpawn_TitanSpawn( wave3, "Scorch", < 3460, 586, 144 >, 180, "right", 1.0 )
	WaveSpawn_TitanSpawn( wave3, "Tone", < 3522, 44, 150 >, 180, "right", 1.2 )
	WaveSpawn_ReaperSpawn( wave3, "TickReaper", < 3501, 485, 145 >, 180, "", 0.5 )
	...
	WaveSpawn_TitanSpawn( wave3, "Nuke", < 3545, 223, 144 >, 180, "mid" )
	WaveSpawn_WaitEnemyAliveAmount( wave3, 8 )
	
	WaveSpawn_ReaperSpawn( wave3, "Reaper", < 2925, 54, 160 >, 180, "right", 1.5 )
	WaveSpawn_ReaperSpawn( wave3, "TickReaper", < 2433, 3533, 17 >, -90, "", 1.5 )
	WaveSpawn_InfantrySpawn( wave3, "Stalker", < 2916, 8, 158 >, 0.0, "right_infantry", 0.5 )
	WaveSpawn_TitanSpawn( wave3, "Scorch", < 314, 2055, 168 >, -90, "leftDangerClose", 1.2 )
	WaveSpawn_TitanSpawn( wave3, "Scorch", < 1665, 3238, 14 >, -90, "", 1.0 )
	WaveSpawn_TitanSpawn( wave3, "Scorch", < 3360, 583, 150 >, 180, "mid", 0.7 )
	...
	WaveSpawn_InfantrySpawn( wave3, "CloakDrone", < 1926, 2160, 2560 >, 0.0, "", 1.0, "", 0.0, eFDSD.EXCLUSIVE | eFDSD.INSANE )
	WaveSpawn_InfantrySpawn( wave3, "Stalker", < -3053, -1765, 384 >, 0.0, "", 0.5 )
	WaveSpawn_TitanSpawn( wave3, "Sniper", < 3403, 82, 148 >, 180, "" )
	...
	*/
	...
	WaveSpawn_InfantrySpawn( wave4, "CloakDrone", < 1926, 2160, 2560 >, 0.0, "", 1.0, "", 0.0, eFDSD.EXCLUSIVE | eFDSD.INSANE )
	WaveSpawn_ReaperSpawn( wave4, "TickReaper", < 3726, 1366, 101 >, -90, "" )
	...
	WaveSpawn_ReaperSpawn( wave4, "TickReaper", < 3073, 2962, 11 >, -90, "", 1.2 )
	...
	WaveSpawn_InfantrySpawn( wave4, "Drones", < -254, 3054, 2560 >, 0.0, "leftDrone", 1.0 )
	WaveSpawn_InfantrySpawn( wave4, "Drones", < -254, 3054, 2560 >, 0.0, "leftDrone", 1.0 )
	...
	WaveSpawn_InfantrySpawn( wave4, "CloakDrone", < 3395, 301, 2560 >, 0.0, "", 1.0, "", 0.0, eFDSD.EXCLUSIVE | eFDSD.INSANE )
	...
	WaveSpawn_InfantrySpawn( wave4, "Stalker", < -3092, -1760, 384 >, 0.0, "", 0.5 )
	WaveSpawn_InfantrySpawn( wave4, "Stalker", < -2476, -494, 384 >, 0.0, "", 0.4 )
	WaveSpawn_InfantrySpawn( wave4, "Stalker", < -3100, 1254, 320 >, 0.0, "", 2.5 )
	WaveSpawn_TitanSpawn( wave4, "Scorch", < 314, 2055, 168 >, -90, "leftDangerClose", 1.2 )
	WaveSpawn_TitanSpawn( wave4, "Scorch", < 2500, 1433, 58 >, 180, "", 1.0 )
	...
	*/
	...
	WaveSpawn_InfantrySpawn( wave5, "Drones", < -254, 3054, 2560 >, 0.0, "leftDrone", 1.0 )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < 265, -2077, 2560 >, 0.0, "midDrone", 1.0 )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < -498, 3119, 2560 >, 0.0, "closeDrone3", 1.0 )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < 128, -2075, 2560 >, 0.0, "closeDrone1", 1.0 )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < -22, -2102, 2560 >, 0.0, "closeDrone2", 1.0 )
	...
	WaveSpawn_InfantrySpawn( wave5, "CloakDrone", < 1926, 2160, 2560 >, 0.0, "", 0.5, "", 0.0, eFDSD.EXCLUSIVE | eFDSD.INSANE )
	...
	WaveSpawn_InfantrySpawn( wave5, "CloakDrone", < 3395, 301, 2560 >, 0.0, "", 0.5, "", 0.0, eFDSD.EXCLUSIVE | eFDSD.INSANE )
	WaveSpawn_WaitEnemyAliveAmount( wave5, 8 )
	...
	WaveSpawn_InfantrySpawn( wave5, "Drones", < 265, -2077, 2560 >, 0.0, "midDrone", 1.0 )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < -498, 3119, 2560 >, 0.0, "closeDrone3", 1.0 )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < -498, 3119, 2560 >, 0.0, "closeDrone3" )
	WaveSpawn_WaitEnemyAliveAmount( wave5, 8 )
