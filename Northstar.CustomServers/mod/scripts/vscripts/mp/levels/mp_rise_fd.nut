...
void function initFrontierDefenseData()
{
	...
	FD_DropPodSpawns.append(< -5688, -1339, 384 >)
	FD_DropPodSpawns.append(< -3241, -476, 384 >)
	FD_DropPodSpawns.append(< -3726, 1458, 320 >)
	...
	wave1.append(CreateWarningEvent( FD_IncomingWarnings.EnemyTitansIncoming, index++ ))
    wave1.append(CreateNukeTitanEvent(< 3562.689941 , 597.062988 , 147.031006 >,< 0, -180, 0 >,"mid",index++))
    wave1.append(CreateWaitForTimeEvent(5.0,index++))
    wave1.append(CreateWaitUntilAliveEvent(0,index++))
    wave1.append(CreateNukeTitanEvent(< 2328.473877, -96.916878, 228.558044 >,< -0.000000 , -157.455994 , 0.000000 >,"midalt",index++))
    wave1.append(CreateWaitForTimeEvent(5.0,index++))
    wave1.append(CreateWaitUntilAliveEvent(0,index++))
    ...
    wave1.append(CreateNukeTitanEvent(< 3599.909912 , 21.781300 , 193.906006 >,< 0, 0, 0 >,"midalt",index++))
    ...
    wave1.append(CreateNukeTitanEvent(< 2072.510010 , -114.669998 , 240.608994 >,< 0.000000 , -2.153320 , 0.000000 >,"mid",0))
    ...
    wave2.append(CreateScorchTitanEvent(< 3599.909912 , 21.781300 , 193.906006 >,< 0, 0, 0 >,"mid",index++))
    ...
    wave2.append(CreateScorchTitanEvent(< 1768.823853, -120.047035, 226.738663 >,< -0.000000 , 154.104996 , 0.000000 >,"",index++))
	...
	wave2.append(CreateWarningEvent( FD_IncomingWarnings.PreArcTitan, index++ ))
    wave2.append(CreateWaitForTimeEvent(5.0,index++))
    wave2.append(CreateWaitUntilAliveEvent(0,index++))
    wave2.append(CreateArcTitanEvent(< 3562.780029 , 597.000000 , 147.031006 >,< 0, 0, 0 >,"mid",index++))
    ...
    wave2.append(CreateArcTitanEvent(< 3600.000000 , 21.718800 , 194.000000 >,< 0, 0, 0 >,"right",index++))
    ...
    wave2.append(CreateScorchTitanEvent(< 3146.129883 , 42.906300 , 172.250000 >,< 0, 0, 0 >,"midalt",index++))
    ...
    wave2.append(CreateArcTitanEvent(< 1324.250000 , 43.000000 , 256.625000 >,< -0.000000 , 154.600006 , 0.000000 >,"right",index++))
    ...
    wave2.append(CreateScorchTitanEvent(< 2474.560059 , 1404.660034 , 63.562500 >,< 0, 0, 0 >,"",index++))
    wave2.append(CreateWaitForTimeEvent(0.5170288,index++))
    ...
    wave2.append(CreateArcTitanEvent(< 1272.239990 , 68.484001 , 256.885986 >,< -0.000000 , 154.994003 , 0.000000 >,"right",index++))
    ...
    wave2.append(CreateWaitForTimeEvent(0.5830078,index++))
    wave2.append(CreateScorchTitanEvent(< 1209.160034 , 96.343803 , 256.281006 >,< -0.000000 , 154.688004 , 0.000000 >,"mid",index++))
    ...
    wave2.append(CreateSuperSpectreEvent(< 3145.469971 , 43.000000 , 169.281006 >,< 0, -180, 0 >,"",index++))
    wave2.append(CreateWaitForTimeEvent(0.56695557,index++))
    ...
    wave2.append(CreateNukeTitanEvent(< 2775.560059 , 220.063004 , 174.468994 >,< 0, 0, 0 >,"mid",index++))
    ...
    wave2.append(CreateArcTitanEvent(< 1344.760010 , 33.344200 , 256.279999 >,< -0.000000 , 154.438995 , 0.000000 >,"right",index++))
    ...
    wave3.append(CreateArcTitanEvent(< 3562.780029 , 597.000000 , 147.031006 >,< 0, 0, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(0.8170166,index++))
    wave3.append(CreateArcTitanEvent(< 1904.310059 , 3554.219971 , 13.718800 >,< 0, -90, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(1.3829956,index++))
    wave3.append(CreateArcTitanEvent(< 2474.689941 , 1404.589966 , 63.562500 >,< 0, 0, 0 >,"",index++))
    ...
    wave3.append(CreateToneSniperTitanEvent(< 3599.439941 , 21.687500 , 193.781006 >,< 0, 0, 0 >,index++))
    wave3.append(CreateWaitForTimeEvent(5.017029,index++))
	wave3.append(CreateWarningEvent( FD_IncomingWarnings.ReaperTicks, index++ ))
    wave3.append(CreateSuperSpectreEventWithMinion(< 3145.469971 , 43.000000 , 419.500000 >,< 0, -180, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(0.3659668,index++))
    wave3.append(CreateToneTitanEvent(< 2474.090088 , 1404.560059 , 63.500000 >,< 0, 0, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(0.23400879,index++))
    wave3.append(CreateSuperSpectreEventWithMinion(< 1904.189941 , 3540.340088 , 11.500000 >,< 0, -90, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(0.5,index++))
    wave3.append(CreateToneTitanEvent(< 2695.500000 , 3543.280029 , 30.843800 >,< 0, -90, 0 >,"",index++))
    ...
    wave3.append(CreateArcTitanEvent(< 1407.380005 , 4.218750 , 249.938004 >,< 0.000000 , 154.072006 , 0.000000 >,"right",index++))
    ...
    wave3.append(CreateToneSniperTitanEvent(< 3730.687256, 1272.731079, 105.642822 >,< -0.000000 , -164.445999 , 0.000000 >,index++))
	wave3.append(CreateWarningEvent( FD_IncomingWarnings.PreNukeTitan, index++ ))
    wave3.append(CreateWaitForTimeEvent(5.0,index++))
    wave3.append(CreateWaitUntilAliveEvent(0,index++))
    wave3.append(CreateToneTitanEvent(< 3599.439941 , 21.687500 , 193.781006 >,< 0, 0, 0 >,"",index++))
    ...
    wave3.append(CreateNukeTitanEvent(< 3562.689941 , 597.062988 , 147.031006 >,< 0, 0, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(1.3829956,index++))
    wave3.append(CreateNukeTitanEvent(< 1904.250000 , 3554.129883 , 13.718800 >,< 0, -90, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(1.184021,index++))
    wave3.append(CreateNukeTitanEvent(< 3146.129883 , 42.906300 , 172.250000 >,< 0, 0, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(0.5999756,index++))
    wave3.append(CreateToneSniperTitanEvent(< 2645.750000 , -114.375000 , 234.563004 >,< 0, 0, 0 >,index++))
    wave3.append(CreateWaitForTimeEvent(1.4330444,index++))
    wave3.append(CreateSpawnDroneEvent(< 3503.659912 , 11.184200 , 463.877014 >,< 0, 0, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(0.6669922,index++))
    wave3.append(CreateDroppodStalkerEvent(< -991.843994 , 411.093994 , 254.656006 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(5.0,index++))
    wave3.append(CreateWaitUntilAliveEvent(0,index++))
    wave3.append(CreateSuperSpectreEventWithMinion(< 3325.479980 , 201.667007 , 179.955002 >,< -0.000000 , -158.610992 , 0.000000 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(0.8670044,index++))
    wave3.append(CreateSuperSpectreEventWithMinion(< 1677.130005 , 3349.620117 , 18.890200 >,< 0.000000 , -153.281006 , 0.000000 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(5.217041,index++))
    wave3.append(CreateSpawnDroneEvent(< 191.919998 , -1930.219971 , 2580 >,< 0, -175, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(1.315979,index++))
    wave3.append(CreateSpawnDroneEvent(< 478.014008 , -2108.659912 , 2580 >,< 0, -175, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(0.9000244,index++))
    wave3.append(CreateArcTitanEvent(< 2474.689941 , 1404.589966 , 63.562500 >,< 0, 0, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(1.2669678,index++))
    wave3.append(CreateToneTitanEvent(< 3562.219971 , 596.968994 , 147.031006 >,< 0, 0, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(0.8330078,index++))
    wave3.append(CreateToneTitanEvent(< 1904.339966 , 3553.659912 , 13.750000 >,< 0, -90, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(1.1669922,index++))
    wave3.append(CreateToneTitanEvent(< 3599.439941 , 21.687500 , 193.781006 >,< 0, 0, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(1.1329956,index++))
    wave3.append(CreateScorchTitanEvent(< 1580.530029 , 3133.030029 , 12.375000 >,< 0, 0, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(1.0840454,index++))
    wave3.append(CreateScorchTitanEvent(< 3146.129883 , 42.906300 , 172.250000 >,< 0, 0, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(0.782959,index++))
    wave3.append(CreateScorchTitanEvent(< 2646.219971 , -114.280998 , 234.438004 >,< 0, 0, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(1.1500244,index++))
    wave3.append(CreateNukeTitanEvent(< 2368.409912 , 2199.159912 , 11.031300 >,< 0, 0, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(1.2669678,index++))
    wave3.append(CreateNukeTitanEvent(< 3321.590088 , 3089.659912 , 53.437500 >,< 0, -90, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(1.0,index++))
    wave3.append(CreateNukeTitanEvent(< 2474.560059 , 1404.660034 , 63.562500 >,< 0, 0, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(5.0,index++))
    wave3.append(CreateWaitUntilAliveEvent(0,index++))
    wave3.append(CreateArcTitanEvent(< 1904.310059 , 3554.219971 , 13.718800 >,< 0, -90, 0 >,"rightSwitch",index++))
    wave3.append(CreateWaitForTimeEvent(0.79992676,index++))
    wave3.append(CreateArcTitanEvent(< 3562.780029 , 597.000000 , 147.031006 >,< 0, 0, 0 >,"right",index++))
    wave3.append(CreateWaitForTimeEvent(1.0999756,index++))
    wave3.append(CreateArcTitanEvent(< 1580.630005 , 3133.000000 , 12.375000 >,< 0, 0, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(1.3000488,index++))
    wave3.append(CreateArcTitanEvent(< 2695.469971 , 3543.840088 , 31.062500 >,< 0, -90, 0 >,"left1",index++))
    wave3.append(CreateWaitForTimeEvent(1.4000244,index++))
    wave3.append(CreateArcTitanEvent(< 2730.000000 , 2866.090088 , 13.093800 >,< 0, -90, 0 >,"left1",index++))
    wave3.append(CreateWaitForTimeEvent(1.2999268,index++))
    wave3.append(CreateArcTitanEvent(< 991.500000 , 3212.439941 , 79.531303 >,< 0, -90, 0 >,"",index++))
    wave3.append(CreateWaitForTimeEvent(1.5,index++))
    wave3.append(CreateArcTitanEvent(< 2716.030029 , 2445.219971 , 17.687500 >,< 0, -90, 0 >,"rightSwitch",0))
    waveEvents.append(wave3)
    index = 1
    array<WaveEvent> wave4
    wave4.append(CreateSpawnDroneEvent(< 102.452003 , -2172.350098 , 2580 >,< 0, -175, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(1.2000732,index++))
    wave4.append(CreateSpawnDroneEvent(< -445.360992 , 2927.620117 , 2580 >,< 0, -175, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(2.0,index++))
    wave4.append(CreateSpawnDroneEvent(< 70.420502 , -2144.540039 , 2580 >,< 0, -175, 0 >,"closeDrone1",index++))
    wave4.append(CreateWaitForTimeEvent(1.4000244,index++))
    wave4.append(CreateSpawnDroneEvent(< 191.919998 , -1930.219971 , 2580 >,< 0, -175, 0 >,"closeDrone2",index++))
    wave4.append(CreateWaitForTimeEvent(1.5,index++))
    wave4.append(CreateSpawnDroneEvent(< -417.548004 , 2959.649902 , 2580 >,< 0, -175, 0 >,"closeDrone3",index++))
    wave4.append(CreateWaitForTimeEvent(5.0,index++))
    wave4.append(CreateWaitUntilAliveEvent(0,index++))
    wave4.append(CreateSpawnDroneEvent(< 74.639198 , -2204.379883 , 2580 >,< 0, -175, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(0.8000488,index++))
    wave4.append(CreateScorchTitanEvent(< 3562.689941 , 597.062988 , 147.031006 >,< 0, 0, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(1.1999512,index++))
    wave4.append(CreateSpawnDroneEvent(< -445.360992 , 2927.620117 , 2580 >,< 0, -175, 0 >,"closeDrone3",index++))
    wave4.append(CreateWaitForTimeEvent(1.5,index++))
    wave4.append(CreateScorchTitanEvent(< 3599.909912 , 21.781300 , 193.906006 >,< 0, 0, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(0.9000244,index++))
    wave4.append(CreateScorchTitanEvent(< 3146.129883 , 42.906300 , 172.250000 >,< 0, 0, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(0.9000244,index++))
    wave4.append(CreateArcTitanEvent(< 2474.689941 , 1404.589966 , 63.562500 >,< 0, 0, 0 >,"",index++))
    ...
    wave4.append(CreateScorchTitanEvent(< 2695.409912 , 3543.750000 , 31.031300 >,< 0, -90, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(0.5999756,index++))
    wave4.append(CreateScorchTitanEvent(< 1930.030029 , 3156.879883 , 11.156300 >,< 0, -90, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(0.79992676,index++))
    wave4.append(CreateSuperSpectreEventWithMinion(< 2485.379883 , 2253.969971 , 8.031250 >,< 0.000000 , -151.039993 , 0.000000 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(0.20007324,index++))
    wave4.append(CreateScorchTitanEvent(< 1585.530029 , 3552.379883 , 53.968800 >,< 0, -90, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(0.5999756,index++))
    ...
    wave4.append(CreateArcTitanEvent(< 3171.560059 , 608.468994 , 150.375000 >,< 0, 0, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(0.5999756,index++))
    wave4.append(CreateArcTitanEvent(< 1700.560059 , 1538.380005 , 21.031300 >,< 0, 0, 0 >,"",index++))
    ...
    wave4.append(CreateWaitForTimeEvent(0.5,index++))
    wave4.append(CreateNukeTitanEvent(< 3599.909912 , 21.781300 , 193.906006 >,< 0, 0, 0 >,"midalt",index++))
    ...
    wave4.append(CreateWaitForTimeEvent(1.2999268,index++))
    wave4.append(CreateSuperSpectreEventWithMinion(< 2612.909912 , 3263.360107 , 8.372550 >,< 0.000000 , -93.867203 , 0.000000 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(1.5,index++))
    wave4.append(CreateSpawnDroneEvent(< 102.452003 , -2172.350098 , 2580 >,< 0, -175, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(1.4000244,index++))
    wave4.append(CreateScorchTitanEvent(< 1904.250000 , 3554.129883 , 13.718800 >,< 0, -90, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(1.5,index++))
    wave4.append(CreateScorchTitanEvent(< 2715.969971 , 2445.129883 , 17.687500 >,< 0, -90, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(0.6999512,index++))
    wave4.append(CreateScorchTitanEvent(< 1580.530029 , 3133.030029 , 12.375000 >,< 0, 0, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(0.60009766,index++))
    wave4.append(CreateToneSniperTitanEvent(< 2695.500000 , 3543.280029 , 30.843800 >,< 0, -90, 0 >,index++))
    wave4.append(CreateWaitForTimeEvent(5.0,index++))
    wave4.append(CreateWaitUntilAliveEvent(6,index++))
    wave4.append(CreateArcTitanEvent(< 991.500000 , 3212.439941 , 79.531303 >,< 0, -90, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(1.1000977,index++))
    wave4.append(CreateSpawnDroneEvent(< 74.639198 , -2204.379883 , 2580 >,< 0, -175, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(1.1999512,index++))
    wave4.append(CreateSpawnDroneEvent(< -417.548004 , 2959.649902 , 2580 >,< 0, -175, 0 >,"closeDrone3",index++))
    wave4.append(CreateWaitForTimeEvent(2.0,index++))
    wave4.append(CreateSpawnDroneEvent(< 74.639198 , -2204.379883 , 2580 >,< 0, -175, 0 >,"closeDrone2",index++))
    wave4.append(CreateWaitForTimeEvent(1.2000732,index++))
    wave4.append(CreateSpawnDroneEvent(< 164.108002 , -1962.290039 , 2580 >,< 0, -175, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(1.2999268,index++))
    wave4.append(CreateSpawnDroneEvent(< -417.548004 , 2959.649902 , 2580 >,< 0, -175, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(5.0,index++))
    wave4.append(CreateWaitUntilAliveEvent(6,index++))
    wave4.append(CreateSpawnDroneEvent(< 74.639198 , -2204.379883 , 2580 >,< 0, -175, 0 >,"closeDrone1",index++))
    wave4.append(CreateWaitForTimeEvent(0.9000244,index++))
	wave4.append(CreateWarningEvent( FD_IncomingWarnings.ArcTitanAlt, index++ ))
    wave4.append(CreateArcTitanEvent(< 2716.030029 , 2445.219971 , 17.687500 >,< 0, -90, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(1.5,index++))
    wave4.append(CreateArcTitanEvent(< 3321.659912 , 3089.750000 , 53.437500 >,< 0, -90, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(1.0,index++))
    wave4.append(CreateArcTitanEvent(< 3562.780029 , 597.000000 , 147.031006 >,< 0, 0, 0 >,"right",index++))
    wave4.append(CreateWaitForTimeEvent(0.6999512,index++))
    wave4.append(CreateArcTitanEvent(< 3600.000000 , 21.718800 , 194.000000 >,< 0, 0, 0 >,"right",index++))
    wave4.append(CreateWaitForTimeEvent(0.9000244,index++))
    wave4.append(CreateArcTitanEvent(< 1904.310059 , 3554.219971 , 13.718800 >,< 0, -90, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(1.1999512,index++))
    wave4.append(CreateArcTitanEvent(< 2695.469971 , 3543.840088 , 31.062500 >,< 0, -90, 0 >,"",index++))
    wave4.append(CreateWaitForTimeEvent(1.0999756,index++))
    wave4.append(CreateArcTitanEvent(< 1580.630005 , 3133.000000 , 12.375000 >,< 0, 0, 0 >,"",0))
    waveEvents.append(wave4)
    index = 1
    array<WaveEvent> wave5
    wave5.append(CreateToneSniperTitanEvent(< 3599.439941 , 21.687500 , 193.781006 >,< 0, 0, 0 >,index++))
    wave5.append(CreateWaitForTimeEvent(0.5800781,index++))
    wave5.append(CreateArcTitanEvent(< 3562.780029 , 597.000000 , 147.031006 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(1.4000244,index++))
    wave5.append(CreateArcTitanEvent(< 3146.219971 , 42.875000 , 172.218994 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(0.82995605,index++))
    wave5.append(CreateArcTitanEvent(< 1904.310059 , 3554.219971 , 13.718800 >,< 0, -90, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.0,index++))
    wave5.append(CreateToneTitanEvent(< 2645.750000 , -114.375000 , 234.563004 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(0.5699463,index++))
    wave5.append(CreateToneTitanEvent(< 1580.060059 , 3132.939941 , 12.375000 >,< 0, 0, 0 >,"left0",index++))
    wave5.append(CreateWaitForTimeEvent(0.95007324,index++))
	wave5.append(CreateWarningEvent( FD_IncomingWarnings.NukeTitan, index++ ))
    wave5.append(CreateNukeTitanEvent(< 2474.560059 , 1404.660034 , 63.562500 >,< 0, 0, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.3699951,index++))
    wave5.append(CreateNukeTitanEvent(< 2368.409912 , 2199.159912 , 11.031300 >,< 0, 0, 0 >,"left1",index++))
    wave5.append(CreateWaitForTimeEvent(0.9000244,index++))
    wave5.append(CreateNukeTitanEvent(< 3321.590088 , 3089.659912 , 53.437500 >,< 0, -90, 0 >,"left1",index++))
    wave5.append(CreateWaitForTimeEvent(1.0,index++))
    wave5.append(CreateNukeTitanEvent(< 2695.409912 , 3543.750000 , 31.031300 >,< 0, -90, 0 >,"left1",index++))
    wave5.append(CreateWaitForTimeEvent(1.079956,index++))
    wave5.append(CreateNukeTitanEvent(< 3608.689941 , 324.875000 , 147.031006 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(1.1500244,index++))
    wave5.append(CreateNukeTitanEvent(< 991.468994 , 3212.340088 , 79.500000 >,< 0, -90, 0 >,"left1",index++))
    wave5.append(CreateWaitForTimeEvent(1.2700195,index++))
    wave5.append(CreateSpawnDroneEvent(< 102.452003 , -2172.350098 , 2580 >,< 0, -175, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(0.60998535,index++))
    wave5.append(CreateSpawnDroneEvent(< 196.169998 , -1990.069946 , 2580 >,< 0, -175, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.2999268,index++))
    wave5.append(CreateSpawnDroneEvent(< -417.548004 , 2959.649902 , 2580 >,< 0, -175, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.1000977,index++))
    wave5.append(CreateSpawnDroneEvent(< -355.891998 , 3169.709961 , 2580 >,< 0, -175, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(3.8999023,index++))
    wave5.append(CreateSpawnDroneEvent(< 102.452003 , -2172.350098 , 2580 >,< 0, -175, 0 >,"closeDrone2",index++))
    wave5.append(CreateWaitForTimeEvent(5.0,index++))
    wave5.append(CreateWaitUntilAliveEvent(4,index++))
    wave5.append(CreateSpawnDroneEvent(< 74.639198 , -2204.379883 , 2580 >,< 0, -175, 0 >,"closeDrone1",index++))
    wave5.append(CreateWaitForTimeEvent(0.72998047,index++))
    wave5.append(CreateNukeTitanEvent(< 3562.689941 , 597.062988 , 147.031006 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(0.97998047,index++))
    wave5.append(CreateNukeTitanEvent(< 3599.909912 , 21.781300 , 193.906006 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(1.420044,index++))
    wave5.append(CreateNukeTitanEvent(< 3146.129883 , 42.906300 , 172.250000 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(5.880005,index++))
    wave5.append(CreateToneTitanEvent(< 2645.750000 , -114.375000 , 234.563004 >,< 0, 0, 0 >,"midalt",index++))
    wave5.append(CreateWaitForTimeEvent(0.5999756,index++))
    wave5.append(CreateSpawnDroneEvent(< -417.548004 , 2959.649902 , 2580 >,< 0, -175, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(0.8000488,index++))
    wave5.append(CreateNukeTitanEvent(< 3171.469971 , 608.500000 , 150.375000 >,< 0, 0, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(0.9000244,index++))
    wave5.append(CreateNukeTitanEvent(< 3608.689941 , 324.875000 , 147.031006 >,< 0, 0, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.1199951,index++))
    wave5.append(CreateNukeTitanEvent(< 2474.560059 , 1404.660034 , 63.562500 >,< 0, 0, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(0.79992676,index++))
    wave5.append(CreateToneTitanEvent(< 2367.909912 , 2199.060059 , 11.031300 >,< 0, 0, 0 >,"rightSwitch",index++))
    wave5.append(CreateWaitForTimeEvent(1.5,index++))
    wave5.append(CreateSpawnDroneEvent(< 191.919998 , -1930.219971 , 2580 >,< 0, -175, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.0999756,index++))
    wave5.append(CreateSpawnDroneEvent(< 478.014008 , -2108.659912 , 2580 >,< 0, -175, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.2800293,index++))
    wave5.append(CreateSpawnDroneEvent(< 70.420502 , -2144.540039 , 2580 >,< 0, -175, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.4899902,index++))
    wave5.append(CreateSpawnDroneEvent(< -355.891998 , 3169.709961 , 2580 >,< 0, -175, 0 >,"closeDrone3",index++))
    wave5.append(CreateWaitForTimeEvent(0.5999756,index++))
    wave5.append(CreateSpawnDroneEvent(< -323.829987 , 3141.929932 , 2580 >,< 0, -175, 0 >,"closeDrone3",index++))
    wave5.append(CreateWaitForTimeEvent(5.0,index++))
    wave5.append(CreateWaitUntilAliveEvent(6,index++))
    wave5.append(CreateSpawnDroneEvent(< 196.169998 , -1990.069946 , 2580 >,< 0, -175, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.1600342,index++))
    wave5.append(CreateSpawnDroneEvent(< 445.983002 , -2080.850098 , 2580 >,< 0, -175, 0 >,"",index++))
    ...
    wave5.append(CreateNukeTitanEvent(< 2646.219971 , -114.280998 , 234.438004 >,< 0, 0, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.4499512,index++))
    wave5.append(CreateNukeTitanEvent(< 2368.409912 , 2199.159912 , 11.031300 >,< 0, 0, 0 >,"left1",index++))
    wave5.append(CreateWaitForTimeEvent(0.8399658,index++))
    wave5.append(CreateSpawnDroneEvent(< -417.548004 , 2959.649902 , 2580 >,< 0, -175, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.1600342,index++))
    wave5.append(CreateSpawnDroneEvent(< 196.169998 , -1990.069946 , 2580 >,< 0, -175, 0 >,"closeDrone2",index++))
    wave5.append(CreateWaitForTimeEvent(1.0200195,index++))
    wave5.append(CreateArcTitanEvent(< 3321.659912 , 3089.750000 , 53.437500 >,< 0, -90, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.1999512,index++))
    wave5.append(CreateArcTitanEvent(< 3562.780029 , 597.000000 , 147.031006 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(1.4000244,index++))
    wave5.append(CreateArcTitanEvent(< 2474.689941 , 1404.589966 , 63.562500 >,< 0, 0, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(0.8000488,index++))
    wave5.append(CreateNukeTitanEvent(< 1904.250000 , 3554.129883 , 13.718800 >,< 0, -90, 0 >,"left1",index++))
    wave5.append(CreateWaitForTimeEvent(1.3800049,index++))
    wave5.append(CreateNukeTitanEvent(< 1580.530029 , 3133.030029 , 12.375000 >,< 0, 0, 0 >,"left1",index++))
    wave5.append(CreateWaitForTimeEvent(0.73999023,index++))
    wave5.append(CreateNukeTitanEvent(< 2729.939941 , 2866.000000 , 13.093800 >,< 0, -90, 0 >,"left1",index++))
    wave5.append(CreateWaitForTimeEvent(0.89990234,index++))
    wave5.append(CreateSpawnDroneEvent(< 102.452003 , -2172.350098 , 2580 >,< 0, -175, 0 >,"closeDrone1",index++))
    wave5.append(CreateWaitForTimeEvent(0.5600586,index++))
    wave5.append(CreateSpawnDroneEvent(< 164.108002 , -1962.290039 , 2580 >,< 0, -175, 0 >,"closeDrone2",index++))
    wave5.append(CreateWaitForTimeEvent(5.0,index++))
    wave5.append(CreateWaitUntilAliveEvent(4,index++))
    wave5.append(CreateNukeTitanEvent(< 3599.909912 , 21.781300 , 193.906006 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(0.8000488,index++))
    ...
    wave5.append(CreateNukeTitanEvent(< 2715.969971 , 2445.129883 , 17.687500 >,< 0, -90, 0 >,"left1",index++))
    wave5.append(CreateWaitForTimeEvent(0.60009766,index++))
    wave5.append(CreateToneTitanEvent(< 2474.090088 , 1404.560059 , 63.500000 >,< 0, 0, 0 >,"rightSwitch",index++))
    wave5.append(CreateWaitForTimeEvent(1.5,index++))
    wave5.append(CreateNukeTitanEvent(< 1580.530029 , 3133.030029 , 12.375000 >,< 0, 0, 0 >,"left1",index++))
    wave5.append(CreateWaitForTimeEvent(0.57995605,index++))
    wave5.append(CreateNukeTitanEvent(< 2695.409912 , 3543.750000 , 31.031300 >,< 0, -90, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.420044,index++))
    wave5.append(CreateNukeTitanEvent(< 3321.590088 , 3089.659912 , 53.437500 >,< 0, -90, 0 >,"left1",index++))
    wave5.append(CreateWaitForTimeEvent(1.1199951,index++))
    wave5.append(CreateNukeTitanEvent(< 3599.909912 , 21.781300 , 193.906006 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(0.95996094,index++))
    wave5.append(CreateNukeTitanEvent(< 1700.469971 , 1538.439941 , 21.031300 >,< 0, 0, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(5.0,index++))
    wave5.append(CreateWaitUntilAliveEvent(4,index++))
    wave5.append(CreateNukeTitanEvent(< 2474.560059 , 1404.660034 , 63.562500 >,< 0, 0, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.0300293,index++))
    wave5.append(CreateArcTitanEvent(< 3562.780029 , 597.000000 , 147.031006 >,< 0, 0, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.1699219,index++))
    wave5.append(CreateArcTitanEvent(< 3600.000000 , 21.718800 , 194.000000 >,< 0, 0, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.0200195,index++))
    wave5.append(CreateArcTitanEvent(< 1904.310059 , 3554.219971 , 13.718800 >,< 0, -90, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(1.0,index++))
    wave5.append(CreateNukeTitanEvent(< 3146.129883 , 42.906300 , 172.250000 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(0.8100586,index++))
    wave5.append(CreateNukeTitanEvent(< 2646.219971 , -114.280998 , 234.438004 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(1.4899902,index++))
    wave5.append(CreateNukeTitanEvent(< 2368.409912 , 2199.159912 , 11.031300 >,< 0, 0, 0 >,"left1",index++))
    wave5.append(CreateWaitForTimeEvent(5.0,index++))
    ...
    wave5.append(CreateArcTitanEvent(< 3600.000000 , 21.718800 , 194.000000 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(1.0200195,index++))
    wave5.append(CreateArcTitanEvent(< 3146.219971 , 42.875000 , 172.218994 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(1.0,index++))
    wave5.append(CreateArcTitanEvent(< 1904.310059 , 3554.219971 , 13.718800 >,< 0, -90, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(0.67993164,index++))
    wave5.append(CreateScorchTitanEvent(< 255.968994 , 2110.750000 , 184.938004 >,< 0, -90, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(3.5,index++))
    wave5.append(CreateScorchTitanEvent(< 1700.469971 , 1538.439941 , 21.031300 >,< 0, 0, 0 >,"rightSwitch",index++))
    wave5.append(CreateWaitForTimeEvent(3.5,index++))
    wave5.append(CreateScorchTitanEvent(< 255.968994 , 2110.750000 , 184.938004 >,< 0, -90, 0 >,"",index++))
    wave5.append(CreateWaitForTimeEvent(0.70007324,index++))
    wave5.append(CreateNukeTitanEvent(< 1762.500000 , 758.437988 , 143.593994 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(1.0,index++))
    wave5.append(CreateNukeTitanEvent(< 2646.219971 , -114.280998 , 234.438004 >,< 0, 0, 0 >,"right",index++))
    wave5.append(CreateWaitForTimeEvent(1.4000244,index++))
    wave5.append(CreateNukeTitanEvent(< 1700.469971 , 1538.439941 , 21.031300 >,< 0, 0, 0 >,"right",0))
