...
void function initFrontierDefenseData()
{
	...
	foreach (entity JumpPoint in GetEntArrayByClass_Expensive( "traverse" ) )
		JumpPoint.kv.UseableBy = 1
	...
	wave1.append(CreateWarningEvent( FD_IncomingWarnings.MediumWave, index++ ))
