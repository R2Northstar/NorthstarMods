...
void function initFrontierDefenseData()
{
	...
	AddWaveSpawnCustomSpawnPoint( TEAM_MILITIA, < 2430, 594, 128 >, < 0, 180, 0 > )
...
*/
	...
	WaveSpawn_TitanSpawn( wave4, "Monarch", < 3397, 2145, -48 >, 180, "leftFar1", 5.0 )
	...
	WaveSpawn_TitanSpawn( wave4, "Ronin", < -6, -3462, 121 >, 90, "rightNear", 5.0 )
	...
	WaveSpawn_TitanSpawn( wave4, "Ion", < 2970, -3597, -68 >, 90, "rightNear", 0.5 )
	WaveSpawn_TitanSpawn( wave4, "Ion", < 2521, -3597, -68 >, 90, "rightNear", 2.5 )
	...
	WaveSpawn_TitanSpawn( wave4, "Tone", < -1785, -2252, 101 >, 90, "rightNear", 2.5 )
	WaveSpawn_InfantrySpawn( wave4, "Drones", < 1477, -6026, 320 >, 90, "rightDrone02", 1.0 )
...
*/
	...
	WaveSpawn_TitanSpawn( wave5, "Monarch", < 3400, 1243, -65 >, 180, "midFar", 2.5 )
	WaveSpawn_TitanSpawn( wave5, "Ion", < 3644, 2023, 0 >, 180, "midFar", 5.0 )
	WaveSpawn_TitanSpawn( wave5, "Legion", < 151, 3402, 121 >, -90, "leftFar1", 1.5 )
	WaveSpawn_TitanSpawn( wave5, "Tone", < 613, 3522, 83 >, -90, "leftFar1", 2.5 )
	...
	WaveSpawn_TitanSpawn( wave5, "Ronin", < -1909, 3657, 85 >, -90, "rightSwitchShort1", 2.5 )
	WaveSpawn_TitanSpawn( wave5, "Ronin", < -1909, 3373, 86 >, -90, "rightSwitchShort1", 5.0 )
	WaveSpawn_TitanSpawn( wave5, "Sniper", < 3313, -527, -70 >, 180, "", 2.5 )
	WaveSpawn_TitanSpawn( wave5, "Sniper", < 1721, 3440, 95 >, -90, "", 2.5 )
	...
	WaveSpawn_TitanSpawn( wave5, "Scorch", < 2970, -3597, -68 >, 90, "rightFar01", 0.5 )
	WaveSpawn_TitanSpawn( wave5, "Scorch", < 2521, -3597, -68 >, 90, "rightFar01", 7.0 )
	...
	WaveSpawn_TitanSpawn( wave5, "Legion", < 2695, -3333, -73 >, 90, "leftSwitchShort01", 0.5 )
	WaveSpawn_TitanSpawn( wave5, "Ronin", < 2854, -3538, -73 >, 90, "leftSwitchShort01", 0.5 )
	WaveSpawn_TitanSpawn( wave5, "Ronin", < 2554, -3538, -73 >, 90, "leftSwitchShort01", 5.0 )
	WaveSpawn_TitanSpawn( wave5, "Monarch", < -1793, -2237, 101 >, 0, "rightNear", 1.0 )
	WaveSpawn_TitanSpawn( wave5, "Monarch", < -1784, -1120, 101 >, 0, "rightNear", 1.5 )
