...
void function initFrontierDefenseData()
{
	...
	*/
	...
	WaveSpawn_ReaperSpawn( wave3, "TickReaper", < 313, 3391, 120 >, -90, "", 1.5 )
	WaveSpawn_ReaperSpawn( wave3, "TickReaper", < 3396, 2393, -47 >, 180, "" )
	WaveSpawn_WaitEnemyAliveAmount( wave3, 2 )
	...
	WaveSpawn_ReaperSpawn( wave3, "TickReaper", < -1815, 1375, 84 >, 90, "", 2.5 )
	WaveSpawn_TitanSpawn( wave3, "ArcTitan", < -1883, 3478, 84 >, -90, "rightSwitchShort1", 1.5 )
	WaveSpawn_ReaperSpawn( wave3, "TickReaper", < -549, -3730, 144 >, 90, "", 2.5 )
	...
	*/
	...
	WaveSpawn_ReaperSpawn( wave4, "TickReaper", < -1842, 3301, 86 >, -90, "", 1.2 )
	...
	WaveSpawn_ReaperSpawn( wave4, "TickReaper", < 1795, -3741, 26 >, 90, "rightFar01", 1.2 )
	...
	WaveSpawn_ReaperSpawn( wave4, "TickReaper", < 1700, 3413, 95 >, -90, "", 1.2 )
	...
	WaveSpawn_ReaperSpawn( wave4, "TickReaper", < -269, -2948, 164 >, 90, "", 1.2 )
	WaveSpawn_InfantrySpawn( wave4, "Drones", < 62, -6254, 320 >, 90 , "rightDrone03", 1.0 )
	WaveSpawn_InfantrySpawn( wave4, "Drones", < 1477, -6026, 320 >, 90 , "rightDrone02", 1.0 )
	...
	WaveSpawn_ReaperSpawn( wave4, "TickReaper", < 1690, 3417, 95 >, -90, "", 0.6 )
	...
	WaveSpawn_ReaperSpawn( wave4, "TickReaper", < -1443, 3438, 216 >, -90, "", 2.0 )
	WaveSpawn_ReaperSpawn( wave4, "TickReaper", < 650, 3542, 82 >, -90, "", 1.0 )
	...
	*/
	...
	WaveSpawn_InfantrySpawn( wave5, "PodGrunt", < -1786, -2257, 101 >, 0.0, "midHalfway_infantry" )
	...
	WaveSpawn_InfantrySpawn( wave5, "PodGrunt", < -354, -1161, 256 >, 0.0, "infantyPerch_right3" )
	WaveSpawn_WaitEnemyAliveAmount( wave5, 2 )
	...
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < 2967, -3395, -73 >, 90, "", 1.5 )
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < 2386, -3242, -72 >, 90, "", 2.5 )
	...
	WaveSpawn_TitanSpawn( wave5, "Monarch", < -1784, -1120, 101 >, 0, "rightNear", 1.0, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_WaitEnemyAliveAmount( wave5, 2 )
	
	WaveSpawn_TitanSpawn( wave5, "ArcTitan", < -1443 , 3100 , 124 >, -65 , "rightSwitchShort1", 5.0 )
	WaveSpawn_TitanSpawn( wave5, "ArcTitan", < -1867 , 3356 , 96 >, -90 , "rightSwitchShort1", 5.0 )
	WaveSpawn_TitanSpawn( wave5, "ArcTitan", < -2203 , 2963 , 164 >, -35 , "rightSwitchShort1", 5.0 )
	WaveSpawn_TitanSpawn( wave5, "ArcTitan", < -1858 , 3613 , 96 >, -90 , "rightSwitchShort1", 5.0 )
	WaveSpawn_TitanSpawn( wave5, "ArcTitan", < -2215 , 3278 , 164 >, -90 , "rightSwitchShort1", 5.0 )
	WaveSpawn_TitanSpawn( wave5, "ArcTitan", < -1443 , 3100 , 124 >, -65 , "rightSwitchShort1", 5.0 )
	WaveSpawn_TitanSpawn( wave5, "ArcTitan", < -1867 , 3356 , 96 >, -90 , "rightSwitchShort1", 5.0 )
	WaveSpawn_TitanSpawn( wave5, "ArcTitan", < -2203 , 2963 , 164 >, -35 , "rightSwitchShort1", 5.0 )
	WaveSpawn_TitanSpawn( wave5, "ArcTitan", < -1858 , 3613 , 96 >, -90 , "rightSwitchShort1", 5.0 )
