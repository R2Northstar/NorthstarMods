...
void function initFrontierDefenseData()
{
	...
	wave2.append(CreateDroppodTickEvent(< 1605 , 3012 , 86 >, 4, "leftNear", index++ ) )
	wave2.append(CreateWaitForTimeEvent(1.2,index++))
	wave2.append(CreateDroppodTickEvent(< 570 , 2765 , 76 >, 4, "leftNear", index++ ) )
	wave2.append(CreateWaitForTimeEvent(1.0,index++))
	wave2.append(CreateDroppodTickEvent(< 1053 , 3099 , 96 >, 4, "leftNear", index++ ) )
	wave2.append(CreateWaitForTimeEvent(0.8,index++))
	wave2.append(CreateDroppodTickEvent(< 1299 , 2639 , 84 >, 4, "leftNear", index++ ) )
	wave2.append(CreateWaitForTimeEvent(1.0,index++))
	...
	wave2.append(CreateWaitForTimeEvent(0.5,index++))
	wave2.append(CreateDroppodTickEvent(< 1053 , 3099 , 96 >, 4, "leftNear", 0 ) )
	...
	wave5.append(CreateIonTitanEvent(< 3644, 2023, 0 >,< 0, 180, 0 >,"midFar",index++))
	wave5.append(CreateWaitForTimeEvent(5.0,index++))
	...
	wave5.append(CreateToneTitanEvent(< 613, 3522, 83 >,< 0, -90, 0 >,"leftFar1",index++))
	wave5.append(CreateWaitForTimeEvent(2.5,index++))
	...
	wave5.append(CreateWaitForTimeEvent(5.0,index++))
	wave5.append(CreateToneSniperTitanEvent(< 3313, -527, -70 >,< 0, 180, 0 >,index++))
	wave5.append(CreateWaitForTimeEvent(2.5,index++))
	wave5.append(CreateToneSniperTitanEvent(< 1721, 3440, 95 >,< 0, -90, 0 >,index++))
	wave5.append(CreateWaitForTimeEvent(2.5,index++))
	wave5.append(CreateDroppodGruntEvent(< -354, -1161, 256 >,"infantyPerch_right3",index++))
	wave5.append(CreateWaitForTimeEvent(1.0,index++))
	wave5.append(CreateWaitUntilAliveEvent( 2, index++ ) )
	wave5.append(CreateScorchTitanEvent(< 2970, -3597, -68 >,< 0, 90, 0 >,"rightFar01",index++))
	wave5.append(CreateWaitForTimeEvent(0.5,index++))
	wave5.append(CreateScorchTitanEvent(< 2521, -3597, -68 >,< 0, 90, 0 >,"rightFar01",index++))
	...
	wave5.append(CreateWaitForTimeEvent(5.0,index++))
	wave5.append(CreateMonarchTitanEvent(< -1793, -2237, 101 >,< 0, 0, 0 >,"rightNear",index++))
	wave5.append(CreateWaitForTimeEvent(1.0,index++))
	wave5.append(CreateMonarchTitanEvent(< -1784, -1120, 101 >,< 0, 0, 0 >,"rightNear",index++))
	wave5.append(CreateWaitForTimeEvent(1.0,index++))
	wave5.append(CreateWaitUntilAliveEvent( 2, index++ ) )
