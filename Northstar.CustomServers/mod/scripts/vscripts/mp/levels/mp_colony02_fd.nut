...
void function initFrontierDefenseData()
{
	...
	AddWaveSpawnCustomSpawnPoint( TEAM_MILITIA, < 830, -194, 112 >, < 0, 180, 0 > )
...
*/
	...
	WaveSpawn_TitanSpawn( wave3, "Ronin", < -1968, 1751, 15 >, 0, "", 0.5 )
	WaveSpawn_TitanSpawn( wave3, "Ronin", < 73, 5400, -59 >, -90, "", 2.5 )
	WaveSpawn_TitanSpawn( wave3, "Sniper", < -4133, 2150, 186 >, 0, "", 0.5 )
	WaveSpawn_TitanSpawn( wave3, "Sniper", < -3680, 5041, -40 >, 0, "", 0.5 )
...
*/
	...
	WaveSpawn_TitanSpawn( wave4, "Monarch", < -1998, 3000, -13 >, -35, "", 0.5 )
	...
	WaveSpawn_TitanSpawn( wave4, "Legion", < -1998, 3000, -13 >, -35, "", 0.5 )
	WaveSpawn_TitanSpawn( wave4, "Ronin", < -2260, 2742, -13 >, -35, "", 0.5 )
	WaveSpawn_TitanSpawn( wave4, "Ronin", < -1913, 3414, -13 >, -35, "", 2.5 )
	WaveSpawn_InfantrySpawn( wave4, "Ticks", < -1966, 2649, 1 >, 0, "", 0.3 )
	WaveSpawn_InfantrySpawn( wave4, "Ticks", < -1693, 3165, 3 >, 0, "", 1.5 )
	WaveSpawn_TitanSpawn( wave4, "Northstar", < -4332, 74, 135 >, 0, "", 0.5 )
	WaveSpawn_TitanSpawn( wave4, "Northstar", < -3573, 5198, -14 >, -45, "", 1.5 )
...
*/
	...
	WaveSpawn_TitanSpawn( wave5, "Sniper", < 75, 5262, -59 >, -90, "", 2.0 )
	...
	WaveSpawn_TitanSpawn( wave5, "Northstar", < -3753, -2485, 129 >, 0, "", 2.5 )
	...
	WaveSpawn_TitanSpawn( wave5, "Legion", < 75, 5262, -59 >, -90, "", 0.5 )
	WaveSpawn_TitanSpawn( wave5, "Ronin", < -206, 5486, -70 >, -90, "", 0.5 )
	WaveSpawn_TitanSpawn( wave5, "Ronin", < 263, 5483, -12 >, -90, "", 3.5 )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < 813, 7910, 128 >, -90, "droneFarmside", 1.0 )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < 813, 7910, 128 >, -90, "droneFarmside", 1.5 )
...
void function RegisterCustomFDContent()
{
	...
	foreach ( entity position in aiPositions )
		if (
			position.HasKey( "editorclass" ) && position.kv.editorclass == "info_fd_ai_position" &&
			expect string( position.kv.aiType ).tointeger() != eStationaryAIPositionTypes.LAUNCHER_REAPER
		)
			position.Destroy()
