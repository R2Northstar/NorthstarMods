...
void function initFrontierDefenseData()
{
	...
	*/
	...
	WaveSpawn_TitanSpawn( wave3, "Legion", < -2183, 1800, -384 >, -45, "", 1.0 )
	WaveSpawn_TitanSpawn( wave3, "Legion", < -1629, 1847, -348 >, -145, "", 2.5 )
	...
	WaveSpawn_TitanSpawn( wave3, "Ronin", < 3782, -5270, -385 >, 64, "", 1.0 )
	WaveSpawn_TitanSpawn( wave3, "Ronin", < 4336, -4715, -385 >, 82, "", 1.0 )
	...
	*/
	...
	WaveSpawn_TitanSpawn( wave4, "Monarch", < -1010, 4734, -260 >, -90, "", 0.6 )
	WaveSpawn_TitanSpawn( wave4, "Monarch", < -515, 4717, -260 >, -90, "", 1.5 )
	...
	WaveSpawn_TitanSpawn( wave4, "Legion", < 4509, -4418, -384 >, 180, "", 1.0 )
	WaveSpawn_TitanSpawn( wave4, "Legion", < 637, 4923, -251 >, -90, "", 2.5 )
	...
	*/
	...
	WaveSpawn_TitanSpawn( wave5, "Monarch", < 1279, -5194, -185 >, 45, "", 0.6 )
	WaveSpawn_TitanSpawn( wave5, "Monarch", < -311, 4097, -255 >, -90, "", 1.5 )
	...
	WaveSpawn_TitanSpawn( wave5, "Northstar", < -1352, 11, -384 >, -13, "", 2.5 )
