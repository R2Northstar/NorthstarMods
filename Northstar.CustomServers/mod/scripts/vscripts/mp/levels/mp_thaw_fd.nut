...
void function initFrontierDefenseData()
{
	...
	*/
	...
	WaveSpawn_InfantrySpawn( wave1, "PodGrunt", < 2068, -223, -127 >, 0.0, "", 1.0, "", 0.0, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD )
	WaveSpawn_InfantrySpawn( wave1, "PodGrunt", < 1458, 110, -243 >, 0.0, "", 0.5, "", 0.0, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD )
	WaveSpawn_InfantrySpawn( wave1, "Stalker", < 2164, -735, 16 >, 0.0, "", 1.0 )
	WaveSpawn_InfantrySpawn( wave1, "Stalker", < -1023, 259, -302 >, 0.0, "", 1.0, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_InfantrySpawn( wave1, "Stalker", < -1114, 609, -309 >, 0.0, "", 1.0, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	...
	WaveSpawn_TitanSpawn( wave1, "Nuke", < 614, -781, -308 >, 180, "midNear", 0.3, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave1, "Nuke", < 753, -4250, -213 >, 180, "rightNear", 0.3, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_InfantrySpawn( wave1, "Stalker", < -96, -3675, -200 >, 0.0, "", 1.0 )
	WaveSpawn_ReaperSpawn( wave1, "TickReaper", < 2872, -2388, -378 >, -176, "", 1.3, "", 0.0, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD )
	WaveSpawn_InfantrySpawn( wave1, "Stalker", < 350, -4402, -194 >, 0.0, "", 1.6 )
	WaveSpawn_ReaperSpawn( wave1, "TickReaper", < -922, 2236, -362 >, -172, "", 2.0 )
	WaveSpawn_InfantrySpawn( wave1, "Stalker", < 1049, -3360, -246 >, 0.0, "", 0.5 )
	WaveSpawn_TitanSpawn( wave1, "Mortar", < 3780, -2470, -334 >, 180, "", 0.3, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	...
	*/
	...
	WaveSpawn_InfantrySpawn( wave2, "DropshipGrunt", < -50, -1004, -422 >,40, "", 1.5, "", 0.0, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD, 6 )
	...
	WaveSpawn_InfantrySpawn( wave2, "PodGrunt", < 1486, -2911, -246 >, 0.0, "", 0.3, "", 0.0, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD )
	WaveSpawn_InfantrySpawn( wave2, "Stalker", < 1571, -43, -221 >, 0.0, "", 5.0 )
	WaveSpawn_ReaperSpawn( wave2, "Reaper", < 617, 52, -191 >, 180, "", 0.8, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_ReaperSpawn( wave2, "Reaper", < -489, 897, -318 >, -115, "", 0.6, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_ReaperSpawn( wave2, "Reaper", < -938, 838, -290 >, -115, "", 0.8, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	...
	WaveSpawn_InfantrySpawn( wave2, "DropshipGrunt", < -118, -3714, -250 >, -43, "", 2.5, "", 0.0, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD, 6 )
	WaveSpawn_InfantrySpawn( wave2, "Drones", < 3056, -2845, 2816 >, 0.0, "midDrone" )
	WaveSpawn_TitanSpawn( wave2, "Nuke", < -1092, 843, -299 >, -90, "leftNear", 0.5, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_ReaperSpawn( wave2, "Reaper", < -75, -1057, -379 >, 0, "", 0.8, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_ReaperSpawn( wave2, "Reaper", < -1, -797, -384 >, 0, "", 0.6, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_ReaperSpawn( wave2, "Reaper", < 3045, 404, -318 >, -90, "", 0.8, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_WaitEnemyAliveAmount( wave2, 2 )
	...
	WaveSpawn_TitanSpawn( wave2, "Ion", < 3459, -2928, -301 >, 173, "", 2.5, "", 0.0, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD )
	WaveSpawn_TitanSpawn( wave2, "Mortar", < -1011, 3878, -463 >, -90, "", 0.3, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_InfantrySpawn( wave2, "PodGrunt", < 2147, 2549, 74 >, 0.0, "left_infantry", 0.2, "", 0.0, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD )
	WaveSpawn_InfantrySpawn( wave2, "PodGrunt", < 1473, 2426, 93 >, 0.0, "left_infantry", 0.4, "", 0.0, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD )
	...
	WaveSpawn_TitanSpawn( wave2, "Mortar", < 2696, 1065, -282 >, -90, "", 0.3, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave2, "Mortar", < 3451, -3401, -292 >, 145, "", 0.3, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_InfantrySpawn( wave2, "PodGrunt", < -10, 2062, -327 >, 0.0, "", 0.5, "", 0.0, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD )
	WaveSpawn_InfantrySpawn( wave2, "PodGrunt", < 559, 99, -194 >, 0.0, "", 0.2, "", 0.0, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD )
	WaveSpawn_InfantrySpawn( wave2, "Drones", < -2898, 3657, 2560 >, 0.0, "closeDrone1" )
	WaveSpawn_ReaperSpawn( wave2, "Reaper", < 328, 2479, -386 >, -90, "", 0.6, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_ReaperSpawn( wave2, "Reaper", < 398, 2722, -420 >, -90, "", 0.8, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_ReaperSpawn( wave2, "Reaper", < 1775, -4320, -221 >, 90, "", 0.6, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_ReaperSpawn( wave2, "Reaper", < 2021, -4477, -225 >, 90, "", 0.8, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	...
	*/
	...
	WaveSpawn_TitanSpawn( wave3, "Ronin", < 3673, -2540, -332 >, 175, "", 2.5 )
	WaveSpawn_InfantrySpawn( wave3, "Stalker", < 2433, -3137, -305 >, 0.0, "", 0.5 )
	WaveSpawn_TitanSpawn( wave3, "Ronin", < 3197, -3281, -324 >, 148, "", 2.5 )
	...
	WaveSpawn_TitanSpawn( wave3, "Mortar", < 4178, 100, -382 >, 180, "", 0.6, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave3, "Mortar", < 3690, -2637, -320 >, 180, "", 0.8, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave3, "Mortar", < 3765, -1241, -419 >, 180, "", 0.8, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	...
	WaveSpawn_TitanSpawn( wave3, "ArcTitan", < 759, -4284, -214 >, 180, "", 1.0, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	...
	WaveSpawn_TitanSpawn( wave3, "Monarch", < 4013, 100, -397 >, -165, "", 2.5 )
	WaveSpawn_TitanSpawn( wave3, "Monarch", < 4114, -291, -415 >, -173, "", 1.5 )
	...
	WaveSpawn_TitanSpawn( wave3, "Mortar", < -1514, 3897, -470 >, -90, "", 1.0, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave3, "Mortar", < -1006, 3891, -464 >, -90, "", 1.0, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	...
	*/
	...
	WaveSpawn_TitanSpawn( wave4, "Scorch", < -197, 3952, -447 >, -155, "", 2.5 )
	...
	WaveSpawn_TitanSpawn( wave4, "Ronin", < 2660, 1057, -285 >, -94, "", 2.5 )
	...
	WaveSpawn_TitanSpawn( wave4, "Legion", < 3615, -2674, -325 >, -168, "", 2.5 )
	WaveSpawn_InfantrySpawn( wave4, "Stalker", < 38, -820, -382 >, 0.0, "", 0.5, "", 0.0, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD )
	WaveSpawn_InfantrySpawn( wave4, "Stalker", < 74, -4479, -237 >, 0.0, "", 5.0, "", 0.0, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD )
	WaveSpawn_TitanSpawn( wave4, "Mortar", < -1514, 3897, -470 >, -90, "", 0.5, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave4, "Mortar", < -1006, 3891, -464 >, -90, "", 0.6, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave4, "Mortar", < 4178, 100, -382 >, 180, "", 0.7, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave4, "Mortar", < 3690, -2637, -320 >, 180, "", 0.8, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave4, "Mortar", < 3765, -1241, -419 >, 180, "", 1.5, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	...
	WaveSpawn_TitanSpawn( wave4, "Scorch", < 2796, -4140, -330 >, 140, "", 2.5, "", 0.0, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD )
	...
	WaveSpawn_TitanSpawn( wave4, "Northstar", < 586, 135, -192 >, 180, "", 2.5 )
	...
	*/
	...
	WaveSpawn_InfantrySpawn( wave5, "Drones", < 3056, -2845, 2560 >, 0.0, "midDrone", 1.0, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < 2548, -4935, 2560 >, 0.0, "closeDrone2", 1.0, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < 3056, -2845, 2560 >, 0.0, "rightDrone", 1.0, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Ion", < 3472, -2986, -302 >, 176, "", 1.5 )
	WaveSpawn_TitanSpawn( wave5, "Legion", < 3749, -2088, -354 >, 166, "", 2.5 )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < 4202, 42, -388 >, -151, "", 1.5 )
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < 670, -4362, -220 >, 90, "" )
	WaveSpawn_WaitEnemyAliveAmount( wave5, 0, eFDHT.ALL, eFDSD.EASY | eFDSD.NORMAL | eFDSD.HARD )
	WaveSpawn_WaitEnemyAliveAmount( wave5, 4, eFDHT.ALL, eFDSD.MASTER | eFDSD.INSANE )
	...
	WaveSpawn_TitanSpawn( wave5, "Mortar", < 2394, 1975, -334 >, -143, "", 1.0 )
	...
	WaveSpawn_InfantrySpawn( wave5, "Drones", < -896, 4959, 2560 >, 0.0, "farDrone1", 1.5 )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < -1514, 3897, -470 >, -90, "", 0.5, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < -1006, 3891, -464 >, -90, "", 0.6, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < 4178, 100, -382 >, 180, "", 0.7, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < 3690, -2637, -320 >, 180, "", 0.8, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < 3765, -1241, -419 >, 180, "", 1.5, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_WaitEnemyAliveAmount( wave5, 2 )

	WaveSpawn_TitanSpawn( wave5, "Nuke", < -1054, 3271, -422 >, -95, "", 0.6, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Nuke", < 3708, -2992, -305 >, 164, "", 0.6, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Nuke", < -1985, 2467, -425 >, -61, "", 0.2, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Nuke", < -1904, 2592, -433 >, -55, "", 1.4, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Nuke", < 4053, -83, -410 >, -156, "", 1.0, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Nuke", < 2153, -4379, -278 >, 131, "", 1.0, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Nuke", < 2810, -4170, -332 >, 138, "", 1.5, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Nuke", < -1161, 3367, -422 >, -54, "", 0.5, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_WaitEnemyAliveAmount( wave5, 6, eFDHT.ALL, eFDSD.MASTER | eFDSD.INSANE )
	
	WaveSpawn_TitanSpawn( wave5, "Legion", < 3427, -3299, -303 >, 147, "", 1.5 )
	WaveSpawn_TitanSpawn( wave5, "Monarch", < 4219, -42, -393 >, -158, "", 2.5 )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < 4178, 100, -382 >, 180, "", 0.6, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < 3690, -2637, -320 >, 180, "", 0.8, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < 3765, -1241, -419 >, 180, "", 0.8, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	...
	WaveSpawn_TitanSpawn( wave5, "Scorch", < 3427, -3299, -303 >, 147, "", 1.5 )
	...
	WaveSpawn_TitanSpawn( wave5, "Nuke", < 729, -4295, -215 >,91, "", 0.5, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Nuke", < 2013, -4526, -224 >, 87, "", 0.7, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Nuke", < 2624, -4138, -313 >, 122, "", 1.0, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < 4106, 100, -389 >, -141, "", 1.5 )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < 2419, 1885, -328 >, 180, "", 5.0 )
	WaveSpawn_TitanSpawn( wave5, "Northstar", < 586, 135, -192 >, 180, "", 1.0 )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < -896, 4959, 2560 >, 0.0, "farDrone1", 1.0 )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < -2898, 3657, 2560 >, 0.0, "closeDrone1", 1.0 )
	...
	WaveSpawn_TitanSpawn( wave5, "Nuke", < -1904, 2592, -433 >, -55, "", 1.4, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Nuke", < -1161, 3367, -422 >, -54, "", 1.2, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Nuke", < 2153, -4379, -278 >, 131, "", 1.0, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
	WaveSpawn_TitanSpawn( wave5, "Nuke", < 2810, -4170, -332 >, 138, "", 2.5, "", 0.0, eFDSD.MASTER | eFDSD.INSANE )
