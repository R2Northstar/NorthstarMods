...
void function initFrontierDefenseData()
{
	...
	for( spawnamount = 0; spawnamount < 8; spawnamount++ )
	{
		...
		wave1.append(CreateWaitForTimeEvent( RandomFloatRange( 0.1, 0.6 ),index++))
		wave1.append(CreateWaitUntilAliveEvent( 28, index++ ) )
		wave1.append(CreateSpawnDroneEvent( reaperspawns.getrandom() + < 0, 0, 128>, < 0, 90, 0 > ,"dronesPathing",index++))
		wave1.append(CreateWaitForTimeEvent( RandomFloatRange( 0.1, 0.6 ),index++))
		wave1.append(CreateWaitUntilAliveEvent( 28, index++ ) )
		wave1.append(CreateDroppodStalkerEvent( infantryspawns.getrandom() ,"",index++))
		wave1.append(CreateWaitForTimeEvent( RandomFloatRange( 0.1, 0.6 ),index++))
		wave1.append(CreateWaitUntilAliveEvent( 28, index++ ) )
		wave1.append(CreateDroppodSpectreEvent( infantryspawns.getrandom() ,"",index++))
		wave1.append(CreateWaitForTimeEvent( RandomFloatRange( 0.1, 0.6 ),index++))
		wave1.append(CreateWaitUntilAliveEvent( 28, index++ ) )
		wave1.append(CreateDroppodStalkerEvent( infantryspawns.getrandom() ,"",index++))
		wave1.append(CreateWaitForTimeEvent( RandomFloatRange( 0.1, 0.6 ),index++))
	...
	for( spawnamount = 0; spawnamount < 12; spawnamount++ )
	{
		...
		wave2.append(CreateWaitForTimeEvent( RandomFloatRange( 0.1, 0.6 ),index++))
		wave2.append(CreateWaitUntilAliveEvent( 28, index++ ) )
		wave2.append(CreateSpawnDroneEvent( reaperspawns.getrandom() + < 0, 0, 128>, < 0, 90, 0 > ,"dronesPathing",index++))
		wave2.append(CreateWaitForTimeEvent( RandomFloatRange( 0.1, 0.6 ),index++))
		wave2.append(CreateWaitUntilAliveEvent( 28, index++ ) )
	}
	for( spawnamount = 0; spawnamount < 12; spawnamount++ )
	{
		...
		wave2.append(CreateWaitForTimeEvent( RandomFloatRange( 0.1, 0.6 ),index++))
		wave2.append(CreateWaitUntilAliveEvent( 28, index++ ) )
		wave2.append(CreateSuperSpectreEvent( reaperspawns.getrandom() , < 0, -90, 0> ,"titanMain",index++))
		wave2.append(CreateWaitForTimeEvent( RandomFloatRange( 0.1, 0.6 ),index++))
		wave2.append(CreateWaitUntilAliveEvent( 28, index++ ) )
	}
	...
	for( spawnamount = 0; spawnamount < 4; spawnamount++ )
	{
		...
		wave3.append(CreateWaitForTimeEvent( RandomFloatRange( 0.1, 0.6 ),index++))
		wave3.append(CreateWaitUntilAliveEvent( 28, index++ ) )
		wave3.append(CreateSpawnDroneEvent( reaperspawns.getrandom() + < 0, 0, 128>, < 0, 90, 0 > ,"dronesPathing",index++))
		wave3.append(CreateWaitForTimeEvent( RandomFloatRange( 0.1, 0.6 ),index++))
		wave3.append(CreateWaitUntilAliveEvent( 28, index++ ) )
		wave3.append(CreateDroppodTickEvent( tickspawns.getrandom(),4,"",index++))
		wave3.append(CreateWaitForTimeEvent( RandomFloatRange( 0.1, 0.6 ),index++))
		wave3.append(CreateWaitUntilAliveEvent( 28, index++ ) )
		wave3.append(CreateSuperSpectreEvent( reaperspawns.getrandom() , < 0, -90, 0> ,"titanMain",index++))
		wave3.append(CreateWaitForTimeEvent( RandomFloatRange( 0.1, 0.6 ),index++))
		wave3.append(CreateWaitUntilAliveEvent( 28, index++ ) )
	}
