...
void function initFrontierDefenseData()
{
	...
	*/
	...
	WaveSpawn_ReaperSpawn( wave3, "TickReaper", < 3720, 421, 63 >, 86, "", 2.0, "fd_waveTypeReaperTicks" )
	WaveSpawn_ReaperSpawn( wave3, "TickReaper", < 3077, 3258, 120 >, -75, "", 0.7 )
	WaveSpawn_ReaperSpawn( wave3, "Reaper", < 1752, -2198, 72 >, 13, "", 2.0 )
	WaveSpawn_ReaperSpawn( wave3, "Reaper", < 2446, -2651, 72 >, -36, "", 1.5 )
	WaveSpawn_ReaperSpawn( wave3, "TickReaper", < 1989, 2749, 63 >, -110, "", 0.8 )
	WaveSpawn_ReaperSpawn( wave3, "Reaper", < 3871, -1098, 63 >, -17, "", 0.7 )
	WaveSpawn_ReaperSpawn( wave3, "Reaper", < 955, 1810, 82 >, -50, "", 1.0 )
	WaveSpawn_ReaperSpawn( wave3, "TickReaper", < -266, 2066, 89 >, 50, "", 5.0 )
	...
	*/
	...
	WaveSpawn_ReaperSpawn( wave4, "TickReaper", < -3207, 1641, 165 >, -50, "", 0.5 )
	WaveSpawn_ReaperSpawn( wave4, "TickReaper", < -3012, 3221, 196 >, -50, "", 2.5 )
	...
	WaveSpawn_ReaperSpawn( wave4, "Reaper", < -2243, 2107, 170 >, -105, "", 0.5 )
	WaveSpawn_ReaperSpawn( wave4, "Reaper", < -334, 3300, 90 >, -120, "", 0.5 )
	WaveSpawn_ReaperSpawn( wave4, "Reaper", < -329, 2625, 139 >, -90, "", 0.5 )
	WaveSpawn_ReaperSpawn( wave4, "Reaper", < -3207, 1641, 165 >, -50, "", 0.5 )
	WaveSpawn_ReaperSpawn( wave4, "Reaper", < -3012, 3221, 196 >, -50, "", 0.5 )
	WaveSpawn_ReaperSpawn( wave4, "Reaper", < -592, 2003, 106 >, -33, "", 1.5 )
	...
	*/
	...
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < 5659, -1337, 69 >, -180, "", 0.2 )
	...
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < 4906, 2529, 63 >, -140, "", 0.2 )
	...
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < -2940, 2860, 179 >, -175, "", 0.4, "", 300.0 )
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < 5351, -1142, 78 >, -120, "", 0.2, "", 500.0 )
	...
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < 1858, 2390, 107 >, -130, "", 0.1, "", 300.0 )
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < 1834, -3029, 51 >, 180, "", 0.2, "", 300.0 )
	...
	WaveSpawn_ReaperSpawn( wave5, "Reaper", < 5351, -1142, 78 >, -120, "", 0.2, "", 500.0 )
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < -2940, 2860, 179 >, -175, "", 0.4, "", 300.0 )
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < 5351, -1142, 78 >, -120, "", 0.6, "", 500.0 )
	...
	WaveSpawn_InfantrySpawn( wave5, "Drones", < 2764, 1218, 2580 >, 0.0, "droneMain", 1.0 )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < 2764, 1218, 2580 >, 0.0, "droneMain", 2.5 )
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < 945, 1874, 64 >, 0, "", 1.5 )
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < 1512, 1318, 72 >, 0, "", 1.5 )
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < -355, 2673, 142 >, 0, "", 1.5 )
	WaveSpawn_WaitEnemyAliveAmount( wave5, 8 )
	...
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < 945, 1874, 64 >, 0, "", 0.8 )
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < 1512, 1318, 72 >, 0, "", 1.0 )
	WaveSpawn_ReaperSpawn( wave5, "TickReaper", < -355, 2673, 142 >, 0, "", 2.0 )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < 2764, 1218, 2580 >, 0.0, "droneReverse", 1.0 )
	WaveSpawn_InfantrySpawn( wave5, "Drones", < 2764, 1218, 2580 >, 0.0, "droneReverse", 1.0 )
	WaveSpawn_WaitEnemyAliveAmount( wave5, 8 )
