...
void function initFrontierDefenseData()
{
	...
	*/
	...
	WaveSpawn_InfantrySpawn( wave3, "MortarSpectre", < 588, -269, 688 >, 0.0, "", 0.7 )
	WaveSpawn_InfantrySpawn( wave3, "Spectre", < -394, -606, 560 >, 0.0, "", 0.6 )
	WaveSpawn_InfantrySpawn( wave3, "MortarSpectre", < -525, -2305, 854 >, 0.0, "", 0.5 )
	WaveSpawn_InfantrySpawn( wave3, "Spectre", < -701, -1477, 696 >, 0.0, "", 0.4 )
	WaveSpawn_InfantrySpawn( wave3, "MortarSpectre", < -869, -2984, 930 >, 0.0, "", 0.3 )
	...
	*/
	...
	WaveSpawn_InfantrySpawn( wave4, "MortarSpectre", < 592, -299, 687 >, 0.0, "", 0.3 )
	WaveSpawn_InfantrySpawn( wave4, "MortarSpectre", < -531, -2281, 852 >, 0.0, "", 0.3 )
	WaveSpawn_InfantrySpawn( wave4, "MortarSpectre", < -1071, -3113, 931 >, 0.0, "" )
	WaveSpawn_WaitEnemyAliveAmount( wave4, 4 )
	...
	WaveSpawn_TitanSpawn( wave4, "Mortar", < -6626, 1265, 1367 >, 0, "", 0.5 )
	WaveSpawn_TitanSpawn( wave4, "Mortar", < -6634, 1818, 1359 >, -35, "", 0.5 )
	WaveSpawn_TitanSpawn( wave4, "Mortar", < -5697, 1646, 1356 >, -90, "", 0.5 )
	WaveSpawn_TitanSpawn( wave4, "Mortar", < -5998, 1874, 1364 >, -90, "", 1.5 )
	WaveSpawn_TitanSpawn( wave4, "Northstar", < -6636, -4279, 675 >, 0, "", 1.5 )
	WaveSpawn_TitanSpawn( wave4, "Mortar", < -1088, -284, 536 >, -135, "", 0.5 )
	WaveSpawn_TitanSpawn( wave4, "Mortar", < -607, -476, 560 >, -120, "", 0.6 )
	WaveSpawn_TitanSpawn( wave4, "Mortar", < -868, -788, 624 >, 145, "", 0.7 )
	...
	*/
	...
	WaveSpawn_TitanSpawn( wave5, "Mortar", < -112, -702, 602 >, 180, "", 0.5 )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < -1100, -286, 534 >, -90, "", 0.5 )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < -2873, 1320, 626 >, 180, "", 0.5 )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < -4742, 1492, 1204 >, -90, "", 0.5 )
	WaveSpawn_TitanSpawn( wave5, "Mortar", < -5343, 13, 1309 >, 180, "", 2.5 )
