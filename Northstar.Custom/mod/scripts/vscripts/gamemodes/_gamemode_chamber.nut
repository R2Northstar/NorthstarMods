...
void function ChamberOnPlayerKilled( entity victim, entity attacker, var damageInfo )
{
	...
	{
		if (
			( DamageInfo_GetDamageSourceIdentifier( damageInfo ) == eDamageSourceId.mp_weapon_wingman_n ) ||
			( DamageInfo_GetDamageSourceIdentifier( damageInfo ) == eDamageSourceId.mp_weapon_wingman )
		)
		{
