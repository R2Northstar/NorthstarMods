...
void function FW_createHarvester()
{
	...
	entity Imcminimapentity = CreateEntity( "prop_script" )
	Imcminimapentity.SetOrigin( fw_harvesterImc.harvester.GetOrigin() )
	Imcminimapentity.SetAngles( fw_harvesterImc.harvester.GetAngles() )
	Imcminimapentity.SetValueForModelKey( fw_harvesterImc.harvester.GetModelName() )
	DispatchSpawn( Imcminimapentity )
	Imcminimapentity.SetInvulnerable()
	Imcminimapentity.SetParent( fw_harvesterImc.harvester, "ref" )
	Imcminimapentity.Minimap_SetAlignUpright( true )
	Imcminimapentity.Minimap_AlwaysShow( TEAM_IMC, null )
	Imcminimapentity.Minimap_AlwaysShow( TEAM_MILITIA, null )
	Imcminimapentity.Minimap_SetHeightTracking( true )
	Imcminimapentity.Minimap_SetZOrder( MINIMAP_Z_OBJECT )
	Imcminimapentity.Minimap_SetCustomState( eMinimapObject_prop_script.FD_HARVESTER )
	...
	entity Mltminimapentity = CreateEntity( "prop_script" )
	Mltminimapentity.SetOrigin( fw_harvesterMlt.harvester.GetOrigin() )
	Mltminimapentity.SetAngles( fw_harvesterMlt.harvester.GetAngles() )
	Mltminimapentity.SetValueForModelKey( fw_harvesterMlt.harvester.GetModelName() )
	DispatchSpawn( Mltminimapentity )
	Mltminimapentity.SetInvulnerable()
	Mltminimapentity.SetParent( fw_harvesterMlt.harvester, "ref" )
	Mltminimapentity.Minimap_SetAlignUpright( true )
	Mltminimapentity.Minimap_AlwaysShow( TEAM_IMC, null )
	Mltminimapentity.Minimap_AlwaysShow( TEAM_MILITIA, null )
	Mltminimapentity.Minimap_SetHeightTracking( true )
	Mltminimapentity.Minimap_SetZOrder( MINIMAP_Z_OBJECT )
	Mltminimapentity.Minimap_SetCustomState( eMinimapObject_prop_script.FD_HARVESTER )
